...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (true) {
			System.out.println("============================================");
			System.out.println("1 - Adicionar cliente a fila de chamadas");
			System.out.println("2 - Exibir clientes na fila de chamadas");
			System.out.println("3 - Mandar cliente para atendimento");
			...
			if (opcao == 0) {
				...
				if (fila.isEmpty()) {
					...
					System.out.println("--------------------------------------------");
					System.out.println("O cliente " + fila.get(0) + " foi enviado para o atendimento");
					fila.dequeue();
				}
			} else {
				System.out.println("--------------------------------------------");
